<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\iframe3\application\admin\view\user\user_list.html";i:1604481751;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\header.html";i:1609135838;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\footer.html";i:1609127281;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card-body">
                <form class="layui-search layui-form" action="" method="get">
                    ...
                    <div class="layui-col-md3">
                        <label>手机号</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" name="mobile" value="<?php echo htmlentities($where['mobile']); ?>" placeholder="请输入手机号">
                        </div>
                    </div>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo htmlentities($item['avatar']); ?>" alt=""></td>
