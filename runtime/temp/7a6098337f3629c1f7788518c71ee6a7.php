<?php /*a:3:{s:78:"D:\phpstudy_pro\WWW\iframe3\application\common\view\mg_member\member_list.html";i:1600763989;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\header.html";i:1600763989;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\footer.html";i:1600763989;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('MgMember/add_member'); ?>
                <table class="layui-table">
                    ...
                    <tr>
                        <td><?php echo htmlentities($item['group_name']); ?></td>
                        ...
                        <td><?php echo htmlentities($item['last_login_ip']); ?></td>
                        <td>
                            <?php echo access_button('MgMember/edit_member', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('MgMember/reset_pwd', ['id'=>$item['id']], '修改密码', 'frame', ['400px', '320px']); if($item['id'] != 1): ?>
                            <?php echo access_button('MgMember/del_member', ['id'=>$item['id']], '删除', 'confirm'); ?>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
