<?php /*a:4:{s:74:"D:\phpstudy_pro\WWW\iframe3\application\develop\view\index\add_module.html";i:1600763988;s:70:"D:\phpstudy_pro\WWW\iframe3\application\develop\view\index\header.html";i:1600763988;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\header.html";i:1609127281;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\footer.html";i:1609127281;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md2"></div>
            <div class="layui-card layui-col-md8">
                <div class="layui-card-header">添加后台模块</div>
                <div class="layui-card-body">
                    <form action="" class="layui-form">
                        <div class="layui-form-item">
                            <label class="layui-form-label">后台模块</label>
                            <div class="layui-input-inline">
                                <input type="text" name="mg_module" class="layui-input" value="" placeholder="后台模块名称" lay-verify="required">
                            </div>
                        </div>
                        <div class="layui-form-item">
