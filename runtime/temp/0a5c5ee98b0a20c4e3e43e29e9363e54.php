...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            <div class="layui-card-header"><?php echo htmlentities($page_title); ?> <a href="<?php echo url('prize_list'); ?>" class="layui-btn layui-btn-primary layui-layout-right">返回上级</a></div>
            <div class="layui-card-body">
                <form class="layui-form padsome" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="activity_id" lay-verify="required">
                                ...
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if($v['id'] == $data['activity_id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['title']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="prize_type" value="1" title="虚拟商品" <?php if($data['prize_type'] == 1): ?>checked<?php endif; ?>>
                            <input type="radio" name="prize_type" value="2" title="实物商品" <?php if($data['prize_type'] == 2): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="status" value="1" title="上架" <?php if($data['status'] == 1): ?>checked<?php endif; ?>>
                            <input type="radio" name="status" value="2" title="下架" <?php if($data['status'] == 2): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="prize_name" value="<?php echo htmlentities($data['prize_name']); ?>" required  lay-verify="required" placeholder="请输入奖品名称" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="prize_num" value="<?php echo htmlentities($data['prize_num']); ?>" required  lay-verify="required" placeholder="请输入奖品数量" autocomplete="off" class="layui-input">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">每日发放量</label>
                        <div class="layui-input-block">
                            <input type="text" name="day_num" value="<?php echo htmlentities($data['day_num']); ?>" required  lay-verify="required" placeholder="请输入每日发放量,若为0则不限制" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="win_radio" value="<?php echo htmlentities($data['win_radio']); ?>" required  lay-verify="required" placeholder="输入数字,百分比概率" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="sort" value="<?php echo htmlentities($data['sort']); ?>" required  lay-verify="required" placeholder="请输入中奖概率" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" name="prize_img" id="thumb" value="<?php echo htmlentities($data['prize_img']); ?>">
                        </div>
                    </div>
