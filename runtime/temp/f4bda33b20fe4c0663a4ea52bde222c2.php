<?php /*a:4:{s:72:"D:\phpstudy_pro\WWW\iframe3\application\develop\view\menu\menu_list.html";i:1600763988;s:70:"D:\phpstudy_pro\WWW\iframe3\application\develop\view\index\header.html";i:1600763988;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\header.html";i:1609135838;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\footer.html";i:1609127281;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        ...
        <div class="layui-card layui-col-md8">
            ...
            <div class="layui-card-body">
                <a class="layui-btn" href="<?php echo url('Menu/add_menu', ['mg_module'=>$mg_module]); ?>">添加菜单</a>
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($item['router']); ?></td>
                        <td><?php echo $item['status']==1 ? '正常'  :  '禁用'; ?></td>
                        <td><?php echo $item['sort']; ?></td>
                        <td>
                            <a class="layui-btn layui-btn-xs layui-btn-normal" href="<?php echo url('Menu/edit_menu', ['id'=>$item['id'], 'mg_module'=>$mg_module]); ?>">编辑</a>
                            <a class="layui-btn layui-btn-xs layui-btn-danger" href="javascript: confirm('<?php echo url('Menu/del_menu', ['id'=>$item['id'], 'mg_module'=>$mg_module]); ?>', '是否确认删除？')">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
