<?php /*a:3:{s:76:"D:\phpstudy_pro\WWW\iframe3\application\common\view\mg_group\group_list.html";i:1600763989;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\header.html";i:1600763989;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\footer.html";i:1600763989;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('MgGroup/add_group'); ?>
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($item['group_people']); ?></td>
                        <td><?php echo $item['status']==1 ? '正常'  :  '禁用'; ?></td>
                        <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($item['update_time'])? strtotime($item['update_time']) : $item['update_time'])); ?></td>
                        <td>
                            <?php if($item['access'] != '*'): ?>
                            <?php echo access_button('MgGroup/edit_group', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('MgGroup/del_group', ['id'=>$item['id']], '删除', 'confirm'); ?>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
