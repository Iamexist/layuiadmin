<?php /*a:3:{s:78:"D:\phpstudy_pro\WWW\iframe3\application\admin\view\activity\activity_list.html";i:1604541530;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\header.html";i:1600763989;s:70:"D:\phpstudy_pro\WWW\iframe3\application\common\view\public\footer.html";i:1600763989;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('Activity/add_activity', '添加活动'); ?>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo htmlentities($item['thumb']); ?>" alt=""></td>
                        <td><?php if($item['status'] == 1): ?>开启<?php else: ?>关闭<?php endif; ?></td>
                        <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($item['start_time'])? strtotime($item['start_time']) : $item['start_time'])); ?>
                        <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($item['end_time'])? strtotime($item['end_time']) : $item['end_time'])); ?></td>
                        <td>
                            <!--操作按钮开始-->
                            <?php echo access_button('Activity/edit_activity', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('Activity/del_activity', ['id'=>$item['id']], '删除', 'confirm'); ?>
                            <!--操作按钮结束-->
                        </td>
                    </tr>
                    <?php endforeach; ?>
